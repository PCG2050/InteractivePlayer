...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"c7ad0152-51fd-42dd-8d60-fe028b752c64\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [34 x i8] c"com.companyname.interactiveplayer\00", align 1
...
@__DSOCacheEntry_name.1 = internal constant [17 x i8] c"libc++_shared.so\00", align 1
...
@__DSOCacheEntry_name.8 = internal constant [10 x i8] c"libvlc.so\00", align 1
...
@dso_cache = local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 14
	%struct.DSOCacheEntry {
